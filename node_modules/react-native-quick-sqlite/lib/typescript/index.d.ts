 ...
 */
export declare type SQLBatchTuple = [string] | [string, Array<any> | Array<Array<any>>];
/**
 * status: 0 or undefined for correct execution, 1 for error
 * message: if status === 1, here you will find error description
 * rowsAffected: Number of affected rows if status == 0
 */
export declare type BatchQueryResult = {
    rowsAffected?: number;
};
/**
...
export declare type QuickSQLiteConnection = {
    close: () => void;
    delete: () => void;
